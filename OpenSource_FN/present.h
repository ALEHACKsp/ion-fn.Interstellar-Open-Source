...
HRESULT presenthook(IDXGISwapChain* swap, UINT sync_interval, UINT flags)
{
	...
	if (g_pRenderTargetView)
	{
	    ...
	    windowshit.DrawList->AddText(ImVec2(50, 50), ImColor::HSV(hsv / 255.f, 255, 255), E("           ION FN LEGEND AIMBOT | MORE COMING SOON | MADE BY HackerGod#8696 | Updatet every Day | Aim Fov (+/-)| Have fun with ION FN LEGEND AIIMBOT "));
